...
-- Robust onboarding flow to avoid RLS failure on tenants insert + returning
...
BEGIN
  ...
  INSERT INTO public.tenants (name, cnpj, phone, address, slug)
  VALUES (_name, _cnpj, _phone, _address, _slug)
...
GRANT EXECUTE ON FUNCTION public.create_tenant_onboarding(text, text, text, text, text) TO authenticated;
