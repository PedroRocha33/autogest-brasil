...
import {
  Car, BarChart3, Users, Wrench, ClipboardCheck, DollarSign, Globe, Shield, Zap,
  CheckCircle2, ArrowRight, Star, HelpCircle,
} from "lucide-react";

const plans = [
  {
    name: "Básico", price: 97, description: "Para quem está começando",
  ...
  {
    name: "Profissional", price: 197, description: "Para revendas em crescimento",
  ...
  {
    name: "Marketplace", price: 297, description: "Para revendas profissionais",
    features: ["Tudo do Profissional", "Múltiplos vendedores", "Comissões por vendedor", "Relatórios por vendedor", "Presença no CarboCarros", "Suporte prioritário"],
    blocked: [],
    highlight: false,
  },
];
...
const faqs = [
  { question: "Preciso instalar algum programa?", answer: "Não. O AutoGest funciona 100% no navegador, seja no computador, tablet ou celular. Basta acessar e usar." },
  { question: "Posso testar antes de assinar?", answer: "Sim! Oferecemos um período de teste gratuito para você conhecer todas as funcionalidades antes de decidir." },
  { question: "Como funciona a loja pública?", answer: "Ao cadastrar seus veículos, eles ficam disponíveis automaticamente em uma vitrine online com a marca da sua revenda. Seus clientes podem ver fotos, detalhes e enviar interesse diretamente por lá." },
  { question: "Meus dados estão seguros?", answer: "Sim. Cada revenda tem seus dados completamente isolados. Utilizamos criptografia e controle de acesso por perfil para garantir a segurança das informações." },
  { question: "Posso ter mais de um vendedor usando o sistema?", answer: "Sim! No plano Marketplace você pode adicionar múltiplos vendedores, acompanhar o desempenho individual e controlar comissões de cada um." },
  { question: "O que é o CarboCarros?", answer: "É o nosso marketplace exclusivo. Seus veículos aparecem para milhares de compradores interessados, aumentando suas chances de venda sem custo extra de anúncio." },
  { question: "Consigo controlar despesas e lucro por veículo?", answer: "Sim. O módulo financeiro permite registrar custos de aquisição, serviços realizados e preço de venda, calculando o lucro de cada operação." },
  { question: "Como funciona a captura de leads?", answer: "Quando um visitante demonstra interesse por um veículo na sua loja, as informações dele são salvas automaticamente no seu CRM. Você recebe o lead com nome, telefone e veículo de interesse para fazer o follow-up." },
];
...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Estoque, vendas, financeiro, vistorias e loja pública — tudo em um só lugar. Pare de usar planilhas e comece a vender mais.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button size="lg" className="rounded-full bg-foreground text-background hover:bg-foreground/90 hover:scale-105 active:scale-95 transition-all px-8" asChild>
              <Link to="/register">Começar agora <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
      ...
      {/* Features */}
      <section id="funcionalidades" className="py-16 px-4 bg-card/50">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            O marketplace exclusivo do plano Marketplace. Seus veículos aparecem para milhares de compradores, aumentando suas vendas sem custo extra de anúncio.
          </p>
          <Button size="lg" className="rounded-full bg-foreground text-background hover:bg-foreground/90 hover:scale-105 active:scale-95 transition-all px-8" asChild>
      ...
      <PremiumFooter
        brand="AutoGest"
        description="A plataforma completa para gestão de revendas de veículos. Estoque, vendas, financeiro e muito mais."
        columns={[
          {
            title: "Produto",
            links: [
